...
${s.content}`
 ...
 : category === '건의사항'
    ? `\n[필수 규칙 - 반드시 지킬 것]\n이 안건은 건의사항이며, 학교(교직원)에게 전달되는 공식 문서입니다.\n1. 학생들이 스스로 지키기로 정하는 내용(예: "우리가 ~하자", "~규칙을 지키자")이 보이면, 그 의견 전체를 통째로 삭제하세요. 절대 요약에 포함하지 마세요.\n2. 모든 문장은 반드시 "~해 주시기 바랍니다", "~해 주시면 감사하겠습니다", "~를 부탁드립니다" 중 하나의 어미로 끝내세요.\n3. "~해달라", "~요청한다", "~해주세요", "~해달라고 한다" 같은 표현은 절대 사용하지 마세요. 이런 표현이 하나라도 남아있으면 잘못된 결과입니다.\n`
    : category === '이달의안건'
